...
export default function(sequelize) {
  const Settings = sequelize.define('Settings', {
    ...
    nav_files_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_files_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    nav_games_text: { type: DataTypes.STRING, allowNull: true },
    nav_games_icon: { type: DataTypes.STRING, allowNull: true },
    nav_games_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_games_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    nav_workshops_text: { type: DataTypes.STRING, allowNull: true },
    nav_workshops_icon: { type: DataTypes.STRING, allowNull: true },
    nav_workshops_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_workshops_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    nav_courses_text: { type: DataTypes.STRING, allowNull: true },
    nav_courses_icon: { type: DataTypes.STRING, allowNull: true },
    nav_courses_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_courses_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    nav_classrooms_text: { type: DataTypes.STRING, allowNull: true },
    nav_classrooms_icon: { type: DataTypes.STRING, allowNull: true },
    nav_classrooms_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_classrooms_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    nav_account_text: { type: DataTypes.STRING, allowNull: true },
    nav_account_icon: { type: DataTypes.STRING, allowNull: true },
    nav_account_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_account_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
    ...
    nav_content_creators_visibility: { type: DataTypes.STRING, allowNull: true },
    nav_content_creators_enabled: { type: DataTypes.BOOLEAN, allowNull: true },
