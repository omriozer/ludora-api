...
// GET /old-settings - Get old system settings (forwards to entities/old-settings with enhancements)
router.get('/', optionalAuth, async (req, res) => {
  try {
    ...
    // Get old settings from EntityService
    const results = await EntityService.find('old_settings', query, options);
