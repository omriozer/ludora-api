...
class CouponValidationService {
  ...
  async getApplicablePublicCoupons({ userId, cartItems, cartTotal }) {
    try {
      ...
      luderror.payment('Error finding applicable public coupons:', error);
      throw error;
    }
  }
  ...
  async validateCouponStacking({ couponCodes, userId, cartItems, cartTotal }) {
    try {
      ...
      luderror.payment('Error validating coupon stacking:', error);
      throw error;
    }
  }
  ...
  async getBestCouponForCart({ userId, cartItems, cartTotal }) {
    try {
      ...
      luderror.payment('Error finding best coupon:', error);
      throw error;
    }
  }
